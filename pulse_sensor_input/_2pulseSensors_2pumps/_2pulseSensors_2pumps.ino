...
int pulsePinL = 4;   // pulse sensor purple wire connected to analog pin 4 - LEFT player
int pumpPinR = 8;    // digital out pin to control pump relay
int pumpPinL = 9;    // digital out pin to control pump relay


void setup(){
pinMode(13,OUTPUT);    // pin 13 will blink to your heartbeat!
pinMode(pumpPinR, OUTPUT); // digital out pin to control pump relay
pinMode(pumpPinL, OUTPUT); // digital out pin to control pump relay
